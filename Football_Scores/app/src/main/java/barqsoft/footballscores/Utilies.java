...
public class Utilies
{
    ...
    public static int getTeamCrestByTeamName (String teamname)
    {
        ...
        switch (teamname)
        {
            ...
            case "Hull City FC" : return R.drawable.hull_city_afc_hd_logo;
            ...
            case "Queens Park Rangers FC" : return R.drawable
                    .queens_park_rangers_hd_logo;
            case "Swansea City" : return R.drawable.swansea_city_afc;
            case "Southamption FC" : return R.drawable
                    .southampton_fc;
